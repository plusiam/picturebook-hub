...
export const booksData = [
    ...
    },
    {
        ...
        publisher: "노란상상",
        year: 2018,
        isbn: "978-89-97367-97-9",
        emoji: "🎰",
        
        // 수업 정보
        grade: ["1-2학년", "3-4학년"],
        subject: ["국어", "도덕"],
        tags: ["가족", "추억", "사랑", "놀이", "판타지", "위로"],
        duration: "40분",
        
        // 교사용 정보
        teachingTips: {
            preparation: "A3 자판기 도안, 색연필, 사인펜, 놀이 스티커, 별 스티커, 하트 스티커",
            keyPoints: [
                "추억 속에 살아있는 엄마의 사랑 발견하기",
                "판타지를 통한 외로움의 위로 이해하기",
                "이미 받은 사랑의 재발견과 감사"
            ],
            difficulty: "한부모/조손가정 학생 배려 - '함께 놀아준 소중한 사람'으로 확장",
            extension: "우리 가족 추억 앨범 만들기, 엄마와 함께하는 놀이 데이 계획하기"
        },
        
        // 수업 활동
        activities: {
            before: {
                storytelling: "신우는 엄마와 놀고 싶어요. 그런데 신기한 자판기를 발견했어요! 버튼을 누르면 다양한 엄마가 나와서 함께 놀아준대요. 어떤 엄마들이 나올까요?",
                prediction: [
                    "표지를 보며 자판기에서 나올 엄마들 상상하기",
                    "내가 엄마와 가장 하고 싶은 놀이 3가지 말하기",
                    "엄마와 함께했던 즐거운 놀이 떠올려보기"
                ]
            },
            during: {
                factCheck: [
                    "자판기에서 나온 엄마들은 어떤 엄마들인가요? (피자맘, 공주맘, 공놀이맘, 셀카맘, 자유맘)",
                    "각각의 엄마와 신우는 어떤 놀이를 했나요?",
                    "신우는 놀이를 하면서 어떤 기분이었나요?",
                    "신우가 마지막에 깨달은 특별한 비밀은 무엇인가요?"
                ],
                interaction: [
                    "엄마와 가장 하고 싶은 놀이는 무엇인가요?",
                    "엄마와 함께했던 가장 즐거운 놀이는 무엇이었나요?",
                    "혼자 있을 때 외로움을 달래는 방법이 있나요?",
                    "자판기 엄마들이 진짜 엄마의 추억이라는 걸 알았을 때 어떤 기분일까요?"
                ]
            },
            after: {
                reflection: [
                    "신우의 엄마 자판기는 무엇을 의미할까요?",
